...
library to do the healthcheck and provide the diagnostic endpoint. To access the healthcheck, 
go to http://localhost:5000/heartbeat. As for diagnostic-endpoint, go to http://localhost:5000/diagnostics 
